...
ANTHROPIC_AGENT_ID         = config('ANTHROPIC_AGENT_ID',         default='')
ANTHROPIC_ADVISOR_AGENT_ID = config('ANTHROPIC_ADVISOR_AGENT_ID', default='')
ANTHROPIC_ENV_ID           = config('ANTHROPIC_ENV_ID',           default='')
